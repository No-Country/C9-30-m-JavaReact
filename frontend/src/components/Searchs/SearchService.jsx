...
import { getCampaignServices} from "../../js/search";
...
function SearchService() {
  ...
  useEffect(() => {
    async function run() {
      const campaignService = await getCampaignServices();
      setCampanas(campaignService);
    }
    run();
  }, []);
  ...
  return (
    <div className="search d-flex ">
      <div className="containerSearch">
        ...
        <h4 className="mt-4 mb-5"> Servicios</h4>
